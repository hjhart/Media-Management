...
#ROOT_DIR = "/Volumes/Media/Video/Rename"
ROOT_DIR = "/Volumes/Media/Downloads"
DESTINATION_DIR = "/Volumes/Media/Video/Movies"
...
TV_SERIES_DETECTION = /(s\d{1,2} ?e?\d{2}|\d+x\d+|\b\d[012]\d\b)/i
...
/FZERO/,/multisub/,/fps/,/kbps/,/wunseedee/,/ppvrip/,/dvdscr/,/AMAIBLE/,/XMXG/,/SUBMERGE/,/ExtraTorrentRG/,/WBZ/]
...
if(filename[TV_SERIES_DETECTION])
movie_file = false
...
search_form = page.form_with(:name => "gbqf")
...
if link.href.nil? 
puts "Filename is probably shit. Skipping."; break; 
end
...
if(!@debug)
        begin
          ...
          File.rename(ROOT_DIR + directory + File::SEPARATOR + original_filename, DESTINATION_DIR + File::SEPARATOR + rename_to + extension)
